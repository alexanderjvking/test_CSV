...
if grep -q -o -a -m 1 -h -r "cd /bin" /var/log/ttylog/cli.$(hostname).csv | grep $(whoami); then
...
if grep -q -o -a -m 1 -h -r "okYouAreHERE" /var/log/ttylog/cli.$(hostname).csv | grep $(whoami); then
...
if grep -q -o -a -m 1 -h -r "man file" /var/log/ttylog/cli.$(hostname).csv | grep $(whoami); then
...
if grep -q -o -a -m 1 -h -r "cat imatextfiletoo.txt" /var/log/ttylog/cli.$(hostname).csv | grep $(whoami); then
...
if grep -q -o -a -m 1 -h -r "cat one.txt two.txt three.txt > alltogether.txt" /var/log/ttylog/cli.$(hostname).csv | grep $(whoami); then
...
if grep -q -o -a -m 1 -h -r "vim editme.txt" /var/log/ttylog/cli.$(hostname).csv | grep $(whoami); then
