...
#define PACKAGE_STRING "Snoopy Logger 2.4.6-21-g3f84b29"
...
#define PACKAGE_VERSION "2.4.6-21-g3f84b29"
...
#define SNOOPY_CONF_MESSAGE_FORMAT "[un:%{username} tty_sid:%{env:TTY_SID} hn:%{hostname} cwd:%{cwd} filename:%{filename}]: %{cmdline}"
...
#define VERSION "2.4.6-21-g3f84b29"
